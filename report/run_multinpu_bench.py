...
def extract_stats(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    out = {
        ...
        "text_boxes_raw_count": stats.get("text_boxes_raw_count"),
        "text_boxes_after_dedup_count": stats.get("text_boxes_after_dedup_count"),
        "table_boxes_raw_count": stats.get("table_boxes_raw_count"),
        "table_boxes_after_dedup_count": stats.get("table_boxes_after_dedup_count"),
        "ocr_submit_count": stats.get("ocr_submit_count"),
        "ocr_submit_area_sum": stats.get("ocr_submit_area_sum"),
        "ocr_submit_area_mean": stats.get("ocr_submit_area_mean"),
        "ocr_submit_area_p50": stats.get("ocr_submit_area_p50"),
        "ocr_submit_area_p95": stats.get("ocr_submit_area_p95"),
        "ocr_submit_small_count": stats.get("ocr_submit_small_count"),
        "ocr_submit_medium_count": stats.get("ocr_submit_medium_count"),
        "ocr_submit_large_count": stats.get("ocr_submit_large_count"),
        "ocr_submit_text_count": stats.get("ocr_submit_text_count"),
        "ocr_submit_title_count": stats.get("ocr_submit_title_count"),
        "ocr_submit_code_count": stats.get("ocr_submit_code_count"),
        "ocr_submit_list_count": stats.get("ocr_submit_list_count"),
        "ocr_dedup_skipped_count": stats.get("ocr_dedup_skipped_count"),
        "table_npu_submit_count": stats.get("table_npu_submit_count"),
        "table_dedup_skipped_count": stats.get("table_dedup_skipped_count"),
        "ocr_timeout_count": stats.get("ocr_timeout_count"),
        "ocr_buffered_result_hit_count": stats.get("ocr_buffered_result_hit_count"),
...
def run_benchmark(
    ...
    return {
        ...
        "mean_text_boxes_raw_count": mean("text_boxes_raw_count"),
        "mean_text_boxes_after_dedup_count": mean("text_boxes_after_dedup_count"),
        "mean_table_boxes_raw_count": mean("table_boxes_raw_count"),
        "mean_table_boxes_after_dedup_count": mean("table_boxes_after_dedup_count"),
        "mean_ocr_submit_count": mean("ocr_submit_count"),
        "mean_ocr_submit_area_sum": mean("ocr_submit_area_sum"),
        "mean_ocr_submit_area_mean": mean("ocr_submit_area_mean"),
        "mean_ocr_submit_area_p50": mean("ocr_submit_area_p50"),
        "mean_ocr_submit_area_p95": mean("ocr_submit_area_p95"),
        "mean_ocr_submit_small_count": mean("ocr_submit_small_count"),
        "mean_ocr_submit_medium_count": mean("ocr_submit_medium_count"),
        "mean_ocr_submit_large_count": mean("ocr_submit_large_count"),
        "mean_ocr_submit_text_count": mean("ocr_submit_text_count"),
        "mean_ocr_submit_title_count": mean("ocr_submit_title_count"),
        "mean_ocr_submit_code_count": mean("ocr_submit_code_count"),
        "mean_ocr_submit_list_count": mean("ocr_submit_list_count"),
        "mean_ocr_dedup_skipped_count": mean("ocr_dedup_skipped_count"),
        "mean_table_npu_submit_count": mean("table_npu_submit_count"),
        "mean_table_dedup_skipped_count": mean("table_dedup_skipped_count"),
        "mean_ocr_timeout_count": mean("ocr_timeout_count"),
        "mean_ocr_buffered_result_hit_count": mean("ocr_buffered_result_hit_count"),
        "warmup_md_sha256": wh,
